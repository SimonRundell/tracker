<?php
/**
 * POST /assessmentdefs/create.php
 *
 * Creates a new assessment definition for a unit.
 * Body: { unit_id, part_name, sort_order }
 *
...
try {
    ...
    echo json_encode(['success' => true, 'data' => ['id' => (int)$db->lastInsertId()], 'message' => 'Assessment definition created']);
} catch (Exception $e) {
